...
class CrudViewFormCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'generator:crud-view-form';
     ...
     * @var string
     */
    protected $signature = 'generator:crud-view-form {name}';
     ...
     * @var string
     */
    protected $description = 'Generate templated Crud Form view';
    ...
    {
        return __DIR__.'/../stubs/view-form.stub';
    }
